        ...
        <footer className="footer">
            <div className="container">
                <div className="column">
                    ...
                    <p>Тел: 0(97) 353 04 25</p>
                    <p>Тел: 0(63) 353 04 25</p>
                </div>
                <div className="column">
                    <h4>Магазин</h4>
                    <ul>
                        <li><a href="#motors">Мотори</a></li>
                        <li><a href="#bumpers">Бампера</a></li>
                        <li><a href="#lights">Фари</a></li>
                    </ul>
                </div>
                <div className="column">
                    <h4>Послуги</h4>
                    <ul>
                        ...
                        <li><a href="#questions">Маєте запитання?</a></li>
                    </ul>
                </div>
                <div className="column">
                    <h4>Інфо</h4>
